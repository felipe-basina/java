...
@Configuration
@ComponentScan({ "com.sample.spark" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.sample.spark");
                servletContext.setInitParameter("tapestry.development-modules", "com.sample.spark.services.DevelopmentModule");
